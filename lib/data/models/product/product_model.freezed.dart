...
class _ProductModel implements ProductModel {
  const _ProductModel({required this.id, this.title = '', this.description = '', this.category = '', this.price = 0, this.discountPercentage = 0, this.rating = 0, this.stock = 0, this.brand, this.thumbnail = '',  List<String> images = const <String>[]}): _images = images;
